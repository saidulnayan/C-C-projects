...
//ClearScreen();
  ...
  unsigned int bir=10,per=36,der=110,mur=8;
  unsigned int par=110,cor=90,twr=1199, lur=17,tir=107;
  int qubis=1000,abis=0,qupep=1000,apep=0,quden=110;
  int aden=0,qumun=1000,amun=0,quperk=500,aperk=0,qucoc=400;
  int acoc=0,qutit=100,atit=0,qulux=1000,alux=0;
  int qutid=1000,atid=0,quree=300,aree=0;
  unsigned int m=0,n=0,o=0,p=0,q=0,r=0,s=0,t=0,u=0,v=0,rer=1499;
